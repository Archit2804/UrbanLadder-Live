/*********************************CLASS TO RUN THE TEST THE PROJECT*************************************/
...
public class FurnitureTest extends PageBaseClass {
	...
	public void UrbanLadderTest() throws IOException {
		...
		logger = report.createTest("Get the first three bookshelf details and study chair details"+ " along with the details in beingAtHome section");
		...
		logger.pass("Displaying the error message", MediaEntityBuilder.createScreenCaptureFromPath("C:\\Users\\User\\TeamUrbanLadderv1.0\\Screenshots\\Error_Message.png").build());
