...
public class StudyChairs extends PageBaseClass{
	...
	public static String pricelist[] = new String[3];
	...
	public BeingAtHomePage PrintDetails(){
		...
		try {
			...
			System.out.println("Product Name and price of StudyChairs are:"+finalmap.toString() + "\n");
		...
		//Calling The StudyChairDetailsInExcel() to write the result in the excel file
