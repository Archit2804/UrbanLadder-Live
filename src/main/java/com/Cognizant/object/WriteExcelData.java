...
public class WriteExcelData {
	...
	public static String[] nameofStudyChair = new String[3];
	public static String[] priceofStudyChair = new String[3];
	public static String[] detailsofBeingAtHome = new String[14];

	static XSSFWorkbook workbook = new XSSFWorkbook();

	//Method to print the Bookshelf Details in excel 
	...
	//Method to print the Study Chairs Details in excel 
	...
	//Method to print the Being At Home Details in excel 
